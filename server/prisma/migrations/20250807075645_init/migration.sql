-- CreateEnum
CREATE TYPE "StatusBeerProduct" AS ENUM ('available', 'exported', 'faulty', 'expired', 'reserved');
...
CREATE TABLE "BeerProduct" (
    ...
    "status" "StatusBeerProduct" NOT NULL,
    "notes" TEXT,
    "createdById" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "BeerProduct_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "BeerProduct_code_key" ON "BeerProduct"("code");
...
-- AddForeignKey
ALTER TABLE "BeerProduct" ADD CONSTRAINT "BeerProduct_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
